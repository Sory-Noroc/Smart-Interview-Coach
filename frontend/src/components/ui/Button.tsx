...
const Button: React.FC<ButtonProps> = ({ 
    ...
    const variants = {
        ...
        outline: "border border-brand-primary text-brand-primary dark:text-brand-accent hover:bg-brand-primary hover:text-white dark:hover:bg-brand-accent dark:hover:text-black",
